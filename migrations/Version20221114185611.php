 ...
 */
final class Version20221114185611 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE category_articles (category_id INT NOT NULL, articles_id INT NOT NULL, INDEX IDX_8A7B51312469DE2 (category_id), INDEX IDX_8A7B5131EBAF6CC (articles_id), PRIMARY KEY(category_id, articles_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
